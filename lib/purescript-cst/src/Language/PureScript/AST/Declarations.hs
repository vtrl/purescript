...
importPrim =
  let
    primModName = C.Prim
  in
    addDefaultImport (Qualified (ByModule primModName) primModName)
      . addDefaultImport (Qualified ByNothing primModName)
...
isTrueExpr (Var _ (Qualified (ByModule (ModuleName "Prelude")) (Ident "otherwise"))) = True
isTrueExpr (Var _ (Qualified (ByModule (ModuleName "Data.Boolean")) (Ident "otherwise"))) = True
