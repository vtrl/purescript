...
getDeclarationTitle (P.TypeInstanceDeclaration _ _ _ name _ _ _ _ _) = Just $ either (const "<anonymous>") P.showIdent name
...
convertDeclaration (P.TypeInstanceDeclaration (ss, com) _ _ _ constraints _ className tys _) title =
