...
data Declaration
  ...
  --
  | TypeInstanceDeclaration SourceAnn ChainId Integer (Either Text Ident) [SourceConstraint]  SourcePos (Qualified (ProperName 'ClassName)) [SourceType] TypeInstanceBody
  deriving (Show)
...
declName (TypeInstanceDeclaration _ _ _ n _ _ _ _ _) = IdentName <$> hush n
