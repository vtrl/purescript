...
valueOperator =
  ideValueOp "<$>" (P.Qualified (P.ByModule (mn "Test")) (Left "function")) 2 Nothing

ctorOperator :: Maybe P.SourceType -> IdeDeclarationAnn
ctorOperator =
  ideValueOp ":" (P.Qualified (P.ByModule (mn "Test")) (Right "Cons")) 2 Nothing

typeOperator :: Maybe P.SourceType -> IdeDeclarationAnn
typeOperator =
  ideTypeOp ":" (P.Qualified (P.ByModule (mn "Test")) "List") 2 Nothing
...
ef = P.ExternsFile
  ...
  --, efDeclarations =
    [ P.EDInstance
      -- { edInstanceClassName =
      (P.Qualified (P.ByModule (mn "ClassModule")) (P.ProperName "MyClass"))
      -- , edInstanceName =
